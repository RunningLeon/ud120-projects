...
print  "Fitted line slope is : %.3f" % reg.coef_
print "Fitted line intercept is : %.3f" % reg.intercept_

# linear regression score on training and test data
score_train = reg.score(feature_train, target_train)
score_test = reg.score(feature_test, target_test)
print "score_train: %.3f\nscore_test: %.3f" % (score_train, score_test)
